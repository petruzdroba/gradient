...
public class GradientServiceImpl implements GradientService {
    ...
    private BufferedImage createRadialGradient(int size, Random random) {
        ...
        Color centerColor = new Color(random.nextInt(256), random.nextInt(256), random.nextInt(256));
        Color edgeColor = new Color(random.nextInt(256), random.nextInt(256), random.nextInt(256));
